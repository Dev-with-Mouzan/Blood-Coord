...
import { ChatCircleDots, Drop } from "@phosphor-icons/react";
...
export default function RequesterChatsPage() {
  const { user } = useAuth();
            ...
            <div className="flex flex-col gap-8">
              <div className="text-center">
                ...
                <p className="mt-2 text-ink-500">
                  Chat with donors about your blood requests.
                </p>
              </div>
                  ...
                  {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="mt-1 text-xs text-ink-400">
                        Start a chat from the donor selection modal.
                      </p>
                    </div>
                  ) : (
                      ...
                      {threads.map((thread) => (
                        ...
                        >
                          <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-blood-100">
                            <Drop size={20} weight="fill" className="text-blood-600" />
                          </span>
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="rounded-full bg-blood-100 px-2 py-0.5 text-[10px] font-bold text-blood-700">
                                {thread.donor_blood_group}
                              </span>
                            </div>
