...
import { Drop, ArrowLeft } from "@phosphor-icons/react";
      ...
      <div className="container-shell grid min-h-[100dvh] items-center justify-items-center py-12">
        <div className="w-full max-w-md">
          <div className="relative mb-8 flex items-center justify-center">
            <Link
              to="/"
              className="absolute left-0 inline-flex h-9 w-9 items-center justify-center rounded-full border border-ink-900/10 bg-bone-50 text-ink-500 transition-colors hover:border-ink-900/20 hover:text-ink-900"
